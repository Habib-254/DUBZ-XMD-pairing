...
const fakeVCardQuoted = {
  ...
  message: {
    contactMessage: {
      displayName: "© 𝐷𝑈𝐵𝑍 𝑋𝑀𝐷",
      vcard: `BEGIN:VCARD
VERSION:3.0
FN:© 𝐷𝑈𝐵𝑍 𝑋𝑀𝐷
ORG:DarkWeb MD Official by Mr.Dubai;
...
╭━〔 *ᴀʀꜱʟᴀɴ-xᴍᴅ* 〕━··๏
┃★╭──────────────
┃★│ 👑 Owner : *DarkWeb Md Official Mr.Dubai*
...
await sock.sendMessage(
  jid,
  {
    image: { url: "https://i.ibb.co/5xhhpw1w/IMG-20260623-WA0012.jpg" },
    caption,
    contextInfo: {
      mentionedJid: [jid],
      forwardingScore: 999,
      ...
      forwardedNewsletterMessageInfo: {
        newsletterJid: "120363424074952418@newsletter",
        newsletterName: "❀༒★[𝐷𝑈𝐵𝑍 𝑋𝑀𝐷]★༒❀",
        serverMessageId: 143
      }
    }
  },
...
//coded by DarkWeb MD Official By Mr.Dubai 🇰🇪 
